...
const actionLabels = (t: AdminT): Record<AuditAction, string> => ({
  ...
  REPORT_TAG_ADD: t("auditActionReportTagAdd"),
  REPORT_TAG_REMOVE: t("auditActionReportTagRemove"),
  REPORT_INGEST: t("auditActionReportIngest"),
  REPORT_NOTIFY: t("auditActionReportNotify"),
